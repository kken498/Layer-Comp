...
class CompositorNodeColorSelection(bpy.types.CompositorNodeCustomGroup, Node):
	...
	def getNodetree(self, context):
		...
		node_tree.interface.move_to_parent(bias_range_panel, color1_panel, 5)
		...
		color_socket_1.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_1, color2_panel, 11)
		...
		color_socket_2.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_2, color3_panel, 17)
		...
		color_socket_3.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_3, color4_panel, 23)

		#Panel Color5
		color5_panel = node_tree.interface.new_panel("Color5", default_closed=True)
		#Socket Color
		color_socket_4 = node_tree.interface.new_socket(name = "Color", in_out='INPUT', socket_type = 'NodeSocketColor', parent = color5_panel)
		color_socket_4.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_4, color5_panel, 29)

		#Panel Color6
		color6_panel = node_tree.interface.new_panel("Color6", default_closed=True)
		#Socket Color
		color_socket_5 = node_tree.interface.new_socket(name = "Color", in_out='INPUT', socket_type = 'NodeSocketColor', parent = color6_panel)
		color_socket_5.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_5, color6_panel, 35)

		#Panel Color7
		color7_panel = node_tree.interface.new_panel("Color7", default_closed=True)
		#Socket Color
		color_socket_6 = node_tree.interface.new_socket(name = "Color", in_out='INPUT', socket_type = 'NodeSocketColor', parent = color7_panel)
		color_socket_6.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_6, color7_panel, 41)

		#Panel Color8
		color8_panel = node_tree.interface.new_panel("Color8", default_closed=True)
		#Socket Color
		color_socket_7 = node_tree.interface.new_socket(name = "Color", in_out='INPUT', socket_type = 'NodeSocketColor', parent = color8_panel)
		color_socket_7.default_value = (1.0, 0.0, 0.0, 1.0)
		...
		node_tree.interface.move_to_parent(bias_range_panel_7, color8_panel, 47)
		...
		node_tree.links.new(group_input.outputs[2], color_key.inputs[2])
		#group_input.Saturation -> color_key.Saturation
		node_tree.links.new(group_input.outputs[3], color_key.inputs[3])
		#group_input.Value -> color_key.Value
		node_tree.links.new(group_input.outputs[4], color_key.inputs[4])
		...
		node_tree.links.new(group_input.outputs[8], color_key_001.inputs[4])
		#group_input.Saturation -> color_key_001.Saturation
		node_tree.links.new(group_input.outputs[7], color_key_001.inputs[3])
		#group_input.Hue -> color_key_001.Hue
		node_tree.links.new(group_input.outputs[6], color_key_001.inputs[2])
		...
		node_tree.links.new(group_input.outputs[5], color_key_001.inputs[1])
		...
		node_tree.links.new(group_input.outputs[9], color_key_002.inputs[1])
		#group_input.Hue -> color_key_002.Hue
		node_tree.links.new(group_input.outputs[10], color_key_002.inputs[2])
		#group_input.Saturation -> color_key_002.Saturation
		node_tree.links.new(group_input.outputs[11], color_key_002.inputs[3])
		#group_input.Value -> color_key_002.Value
		node_tree.links.new(group_input.outputs[12], color_key_002.inputs[4])
		#group_input.Hue -> color_key_003.Hue
		node_tree.links.new(group_input.outputs[14], color_key_003.inputs[2])
		#group_input.Saturation -> color_key_003.Saturation
		node_tree.links.new(group_input.outputs[15], color_key_003.inputs[3])
		#group_input.Color -> color_key_003.Key Color
		node_tree.links.new(group_input.outputs[13], color_key_003.inputs[1])
		#group_input.Value -> color_key_003.Value
		node_tree.links.new(group_input.outputs[16], color_key_003.inputs[4])
		#group_input.Color -> color_key_004.Key Color
		node_tree.links.new(group_input.outputs[17], color_key_004.inputs[1])
		#group_input.Hue -> color_key_004.Hue
		node_tree.links.new(group_input.outputs[18], color_key_004.inputs[2])
		#group_input.Saturation -> color_key_004.Saturation
		node_tree.links.new(group_input.outputs[19], color_key_004.inputs[3])
		#group_input.Value -> color_key_004.Value
		node_tree.links.new(group_input.outputs[20], color_key_004.inputs[4])
		#group_input.Hue -> color_key_005.Hue
		node_tree.links.new(group_input.outputs[22], color_key_005.inputs[2])
		#group_input.Saturation -> color_key_005.Saturation
		node_tree.links.new(group_input.outputs[23], color_key_005.inputs[3])
		#group_input.Value -> color_key_005.Value
		node_tree.links.new(group_input.outputs[24], color_key_005.inputs[4])
		#group_input.Color -> color_key_005.Key Color
		node_tree.links.new(group_input.outputs[21], color_key_005.inputs[1])
		#group_input.Color -> color_key_006.Key Color
		node_tree.links.new(group_input.outputs[25], color_key_006.inputs[1])
		#group_input.Hue -> color_key_006.Hue
		node_tree.links.new(group_input.outputs[26], color_key_006.inputs[2])
		#group_input.Saturation -> color_key_006.Saturation
		node_tree.links.new(group_input.outputs[27], color_key_006.inputs[3])
		#group_input.Value -> color_key_006.Value
		node_tree.links.new(group_input.outputs[28], color_key_006.inputs[4])
		#group_input.Hue -> color_key_007.Hue
		node_tree.links.new(group_input.outputs[30], color_key_007.inputs[2])
		#group_input.Saturation -> color_key_007.Saturation
		node_tree.links.new(group_input.outputs[31], color_key_007.inputs[3])
		#group_input.Value -> color_key_007.Value
		node_tree.links.new(group_input.outputs[32], color_key_007.inputs[4])
		#group_input.Color -> color_key_007.Key Color
		node_tree.links.new(group_input.outputs[29], color_key_007.inputs[1])
